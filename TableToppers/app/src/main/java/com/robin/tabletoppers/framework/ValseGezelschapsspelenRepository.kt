...
class ValseGezelschapsspelenRepository: GezelschapsspelPersistenceSource {
    val spelRepository = mutableListOf<Gezelschapsspel>()
    ...
    private fun maakGezelschapsspel(spelId: Int): Gezelschapsspel {
        ...
        val bordspelFotos = arrayOf(
            "gloomhaven",
            "pandemic_legacy_season_2",
            "through_the_ages",
            "terraforming_mars",
            "twilight_struggle",
            "star_wars_rebellion",
        ...
        val dobbelsteenspelNamen = arrayOf(
            "Blueprints",
            "Panamax",
            "Qwixx",
            "Bang The Dice Game",
        ...
        var dobbelsteenspelFotos = arrayOf(
            "blueprints",
            "panamax",
            "qwixx",
            "bang",
        ...
        val kaartspelNamen = arrayOf(
            "Town Of Salem",
            "Uno",
            "Snake Oil",
            "Joking Hazard",
            "Noir Black Box Edition Boxed Card Game",
            "Town Of Salem The Savior of Salem",
            "Pokemon Trading Card Game",
            "YuGiOh",
            "Magic The Gathering",
            "Epic Spell Wars of the Battle Wizards Duel at Mt Skullzfyre"
        )
        val kaartspelFotos = arrayOf(
            "town_of_salem",
            "uno",
            "snake_oil",
            "joking_hazard",
        ...
        if (spelType == 1) {
            gezelschapsspel = Bordspel(
                ...
                doubleArrayOf(
                    Random.nextDouble(1.toDouble(), 10.toDouble()),
                    Random.nextDouble(1.toDouble()),
                    10.toDouble()
                )
            )
        } else if (spelType == 2) {
    ...
    private fun controleerOfSpelNaamAlBestaatInLijst(meegegevenSpel: Gezelschapsspel): Boolean{
        var resultaat = false
        for(repositorySpel in spelRepository){
